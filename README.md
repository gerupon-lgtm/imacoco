...
- 自動検証: 型検査、単体・結合72件、Playwright E2E 5件、全国静的データ全件検査、本番ビルドが成功
- 本番公開: 未実施
...
`npm.cmd run check`は版整合、全国静的データ、型、単体・結合テスト、本番ビルドを検証します。公開前の残件はCloudflare Pagesの公開先決定、独自ドメイン設定、名称の最終確認、PRマージです。手順は[docs/deployment.md](docs/deployment.md)を参照してください。
